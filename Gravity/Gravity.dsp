...
# ADD LINK32 advapi32.lib user32.lib gdi32.lib scrnsave.lib /nologo /subsystem:windows /machine:I386 /out:"Release/Gravity.scr"
...
# ADD LINK32 advapi32.lib user32.lib gdi32.lib scrnsave.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/Gravity.scr" /pdbtype:sept
